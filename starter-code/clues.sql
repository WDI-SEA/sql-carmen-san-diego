...
SELECT name, population, code, cl.language
FROM countries c
...
SELECT ct.name, ct.population, cn.name
FROM cities ct
JOIN countries cn
ON ct.countrycode = cn.code
WHERE ct.population = '91084';


-- She's in ____Santa Monica _ United States______!
