...
-- SELECT name, population FROM countries WHERE region = 'Southern Europe' ORDER BY POPULATION;
...
-- SELECT countrycode, percentage FROM countrylanguages WHERE language = 'Italian';
...
-- SELECT name FROM cities WHERE name LIKE 'Ser%';
