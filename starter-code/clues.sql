...
-- SELECT code, name, region, population FROM countries ORDER BY region ASC;
...
-- SELECT * FROM countrylanguages ORDER BY countrycode DESC;
...
-- SELECT * FROM cities ORDER BY countrycode DESC;
