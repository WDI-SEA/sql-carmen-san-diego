...
-- now we know the code for the lowest population country is 'VAT'
...
-- now we know italian is the official language of Vatican City
...
-- now we've learned that the country code is SMR;
...
-- this gives us the country name San Marino
select * from city where countrycode = 'SMR' AND name != 'San Marino';
-- this gives us the city of Serravalle

-- Clue #5: Oh no, she pulled a switch – there are two cities with very similar names, but in totally different
-- parts of the globe! She's headed to South America as we speak; go find a city whose name is like the one we were
-- headed to, but doesn't end the same. Find out the city, and do another search for what country it's in. Hurry!

select * from city where name like 'Serr%' AND name != 'Serravalle';
-- the city of Serra is in the country code BRA
select name, region from country where code = 'BRA';
...
-- returns with code 211 for capital;
