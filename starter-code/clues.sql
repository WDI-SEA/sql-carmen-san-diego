...
SELECT name, continent, population FROM country WHERE region='Southern Europe' ORDER BY population; 
...
SELECT countrycode, language, percentage FROM countrylanguage WHERE language='Italian' AND percentage=100; SMR
...
--  be flying to.
SELECT name FROM public.city WHERE countrycode='SMR';
Serravalle
San Marino
...
SELECT name, capital, headofstate FROM public.country WHERE code='BRA';
Capital 211
