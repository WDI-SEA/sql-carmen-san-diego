...
world-# ;
world=# SELECT * FROM countries WHERE population < 8000 ORDER BY name DESC;
world=# SELECT * FROM countries WHERE LOWER(region) = 'southern europe';
world=# SELECT * FROM countries WHERE LOWER(region) = 'southern europe' AND population < 8000;
...
world=# SELECT * FROM countries WHERE code = 'BRA';
...
world=# SELECT * FROM cities WHERE population > 91000;
...
world=# SELECT * FROM cities WHERE population =91085;
 id | name | countrycode | district | population 
----+------+-------------+----------+------------
(0 rows)
