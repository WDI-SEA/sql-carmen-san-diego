...
SELECT * FROM country WHERE continent = 'Europe' AND region = 'Southern Europe' ORDER BY population;
Answer: Vatican City (country code: VAT)
...
Answer: countrycode SMR (San Marino)
...
Answer: Santa Monica, California, USA
