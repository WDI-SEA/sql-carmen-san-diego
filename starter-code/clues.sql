...
SELECT * FROM countrylanguage WHERE countrycode = 'VAT' LIMIT 1;
...
SELECT * FROM country WHERE countrycode = 'SMR' LIMIT 1;
...
-- She's in __Santa Monica, CA__________________________!
