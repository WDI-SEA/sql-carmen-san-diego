...
select code,name,localname,region, min(population) as least_populated_country from countries
where region like '%Southern Europe%'
group by code,name,localname,region,population
order by population
...
-- Clue #4: We're booking the first flight out – maybe we've actually got a chance to catch her this time.
 ...
 select name,min(population) as least_populated_country from cities
