...
SELECT * FROM cities WHERE NOT name = 'Serravalle' AND name LIKE 'Serr%';
...
-- headed to, but doesn't end the same. Find out the city, and do another search for what country it's in. Hurry!
 ...
 SELECT * FROM countries where code=(                                                       SELECT countrycode FROM cities WHERE NOT name = 'Serravalle' AND name LIKE 'Serr%'
 );
