...
SELECT * FROM countrylanguages WHERE name = 'Holy See (Vatican Cities State)';
SELECT code, name, region, population FROM countries WHERE region = 'Southern Europe' ORDER BY population ASC;
