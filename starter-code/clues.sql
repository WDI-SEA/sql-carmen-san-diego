...
Selcect name, population from country where region ='Southern Europe' order by population;
-Holy See 
...
SELECT * FROM country language where population < 2000;
...
-- Clue #4: We're booking the first flight out – maybe we've actually got a chance to catch her this time.
 ...
 --  be flying to.
SELECT * FROM city WHERE name = 'San Marino';
...
-- She's in__Santa Monica,CA______________________!
