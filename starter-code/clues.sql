...
--SELECT * FROM countries WHERE region = 'Southern Europe' ORDER BY population LIMIT 1;
...
--SELECT * FROM countries WHERE code = (
  ...
  --   SELECT countrycode FROM countrylanguages WHERE language = 'Italian' AND percentage = 100 -- no semi colon after nest queries
  --    );
...
-- She's in ____________Santa Mononica________________!
